...
def download_video():
    ...
    try:
        ...
        # Fallback exclusivo para YouTube si el formato falla
        if is_youtube and not new_name:
            print("🔁 Reintentando YouTube con formato básico...")
            try:
